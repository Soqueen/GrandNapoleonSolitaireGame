...
//        stack = new Stack(1);
//        stack2 = new Stack(2);
//        stack.setImageView((ImageView) findViewById(R.id.stack0));
//        stack2.setImageView((ImageView) findViewById(R.id.stack1));
//        card1 = new Card(1, 13);
//        card2 = new Card(1, 12);
//        card3 = new Card(1, 1);
//        card4 = new Card(1, 2);
...
//        card8 = new Card(3, 5);
//        card9 = new Card(4, 5);
//        card1.setImageView((ImageView) findViewById(R.id.card0));
//        card2.setImageView((ImageView) findViewById(R.id.card1));
//        card3.setImageView((ImageView) findViewById(R.id.card2));
//        card4.setImageView((ImageView) findViewById(R.id.card3));
        for (int i = 0; i < cards.length; i++) {
            if (i < 48) {
